...
export function TeamManagement({ variant = 'standalone' }: TeamManagementProps) {
  ...
  const myMembership = team?.teamMembers?.find((m) => m.user.id === currentUser?.id);
  ...
  return (
    <section className={embedded ? 'space-y-6' : 'flex-1 p-4 lg:p-8'}>
          ...
          <div className="divide-y">
            {(isOwnerOrAdmin ? team.teamMembers : team.teamMembers.filter((m) => m.user.id === currentUser?.id))
              ...
              .map((member) => {
                ...
                const canRemove = isOwnerOrAdmin && !isMe && member.role !== 'owner';
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="text-sm font-medium text-gray-900 truncate">
                          ...
                          {isMe && <span className="text-xs text-gray-400 ml-1.5">(you)</span>}
                        </p>
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-600 pt-0.5">
                Full access. Can manage billing, team members, apps, API keys, and all settings.
              </p>
            </div>
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-600 pt-0.5">
                Can manage apps, API keys, end-user roles, and invite members. Cannot manage billing or delete the team.
              </p>
            </div>
            <div className="flex items-start gap-3">
